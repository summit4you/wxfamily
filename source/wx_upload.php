...
$url = "http://www.familyday.com.cn/dapi/cp.php?ac=photo&m_auth=".$_GET["m_auth"]."&picids=".$picid."&message=".$_GET["message"]."&friend=0&come=wx&makefeed=1&photosubmit=1&tags=д╛хо©у╪Д";
